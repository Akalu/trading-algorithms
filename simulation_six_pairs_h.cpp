...
int main(int argc, char *argv[])
{
	...
	char *instrnames[12] = {"audcadh", "audusdh", "nzdusdh", "eurchfh",
				"chfjpyh", "eurjpyh", "audjpyh", "gbpjpyh",
				"cadusdh", "cadjpyh", "eurcadh", "gbpusdh"};

	float sdts[60] = {0.001, 1000.0, 0.008, 0.008, 7, 0.0005, 1000.0, 0.005, 0.004, 7,
			  0.0004, 1000.0, 0.004, 0.004, 7, 0.0004, 1000.0, 0.005, 0.003, 8,
			  0.06, 10.0, 0.4, 0.4, 6, 0.04, 10.0, 0.6, 0.4, 6,
			  0.12, 10.0, 0.8, 0.8, 6, 0.08, 10.0, 0.9, 0.6, 6,
			  0.0004, 1000.0, 0.007, 0.004, 7, 0.06, 10.0, 0.9, 0.8, 6,
			  0.0003, 1000.0, 0.006, 0.004, 8, 0.0010, 1000.0, 0.007, 0.007, 8};
	BAR *instrh;
	BAR *instrd;
